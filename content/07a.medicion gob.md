...
| Tema           | Indicadores de Efectividad de Gobierno y Arquitectura: **Sistema de Medidas del Gobierno SOA del FNA: indicadores clave de gestión**                          |
|----------------|------------------------------------------------------------|
...
Lo más importante para la mejora de un proceso, en este caso, el de gobierno SOA del FNA, es seleccionar las mediciones que mejor resulten según criterios como el contexto de la empresa, el nivel de madurez, que para nuestro caso el aspecto tecnológico es el relevante. Sin embargo, y para todos las alternativas de medición que puedan existir, _lo más importante de este ejercicio es empezar con pocas métricas_.

    Nota: en este contexto diferenciamos los conceptos de medición y métricas en la siguiente manera. 

<br>    

Una medición (o su equivalente en este contexto, los indicadores clave de gestión) es un todo aspecto a medir, y por tanto, reúne a varias métricas. Ejemplo: la eficacia del proceso de inversión (...) Mientras que la segunda, la métrica, es un dato que pertenece a aquella. Ejemplo: una métrica de eficacia es las solicitudes de trabajo de arquitectura atendidas en un período de tiempo.

<br>

## Medición del Desempeño del Gobierno SOA del FNA
